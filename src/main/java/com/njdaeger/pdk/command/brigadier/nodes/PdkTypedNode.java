...
public class PdkTypedNode<T> extends PdkCommandNode implements IPdkTypedNode<T>{
    ...
    public PdkTypedNode(ICommandExecutor executor, List<IPdkCommandNode> arguments, String permission, ArgumentBuilder<CommandSourceStack, ?> baseNode, String argumentName, ArgumentType<T> argumentType) {
